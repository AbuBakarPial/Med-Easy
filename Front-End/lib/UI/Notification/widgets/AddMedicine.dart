  ...
  void _submit(NotificationManager manager) async {
    if (_formKey.currentState.validate()) {
      ...
      showTimePicker(
        ...
        setState(() {
          String p = hour.toString();
          String q = minute < 10 ? "0" + minute.toString() : minute.toString();
          time = p + ":" + q;
          print("Selected Time");
          print(time);
        });
        var medicineId =
            await widget._database.insertMedicine(MedicinesTableData(
          name: _name,
          dose: _dose,
